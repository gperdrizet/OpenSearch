...
from classes.wikireader import WikiReader
import functions.parse_helper_functions as helper_funcs
...
def run():
    ...
    wiki = BZ2File('data/enwiki-20240320-pages-articles-multistream.xml.bz2')
    ...
    status = Thread(target=helper_funcs.display, args=(aq, reader))
    status.start() 
